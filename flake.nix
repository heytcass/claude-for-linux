{
  ...
  outputs = { self, nixpkgs, flake-utils }:
    let
      ...
      claudeVersion = "1.1617.0";
      claudeDmgHash = "sha256-AGraefzzG0dnRyURvY65TLcshSRWVkdetKySNmPfAPU=";
      claudeDmgUrl = "https://downloads.claude.ai/releases/darwin/universal/${claudeVersion}/Claude-8d63450d9eae59f17102abdee7bf0759472f30a2.dmg";
